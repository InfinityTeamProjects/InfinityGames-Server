        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryGameIds = table.Column<Guid[]>(type: "uuid[]", nullable: true),
                    WishlistGameIds = table.Column<Guid[]>(type: "uuid[]", nullable: true),
                    CartGameIds = table.Column<Guid[]>(type: "uuid[]", nullable: true),
